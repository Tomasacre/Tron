...
public class Scene extends JPanel{
	...
	public void deplacementJ1() {
		...
		//if(this.xJ1<0 || this.xJ1>1200 ||this.yJ1<0||this.yJ1>800) 
			...
			j1Loose.showMessageDialog(null, "Joueur 2 a gagné", "Fin de partie", JOptionPane.WARNING_MESSAGE);*/
	}
	...
	public void paintComponent(Graphics g) {
		...
		else if(this.xJ1<0 || this.xJ1>1200 ||this.yJ1<0||this.yJ1>800||Map[xJ1/2][yJ1/2]!=0) {
			/*this.xJ1 = 20;
			this.yJ1 = 18;
			this.dx1 = 0;
			this.dy1 = 0;
		...
		else if(this.xJ2<0 || this.xJ2>1200 ||this.yJ2<0||this.yJ2>800||Map[xJ2/2][yJ2/2]!=0) {
			/*this.xJ1 = 20;
			this.yJ1 = 18;
			this.dx1 = 0;
			this.dy1 = 0;
		...
		for (i=0; i<600; i++) {
			for (j=0; j<400; j++) {
				if (Map[i][j]==1) {
					g2.drawImage(this.murJaune.getImgJ1(),  i*2,  j*2, null);
				}
				if (Map[i][j]==2) {
					g2.drawImage(this.murRouge.getImgJ2(),  i*2,  j*2, null);
				}
			}
		}
